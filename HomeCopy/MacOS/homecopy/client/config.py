...
DEFAULT_GLOBAL_HOTKEY = "Meta+Alt+K"
LEGACY_MAC_HOTKEYS = {"Ctrl+Alt+H", "Meta+Alt+H", "Alt+Meta+H", "Ctrl+Option+H", "Option+Cmd+H", "Cmd+Option+H"}
...
class ClientConfig(BaseModel):
    ...
    def load(cls, path: str | Path) -> "ClientConfig":
        ...
        if data.get("global_hotkey") in LEGACY_MAC_HOTKEYS:
